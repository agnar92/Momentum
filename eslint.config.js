...
const browserGlobals = {
    ...
    weeksAgoReturnPct: "readonly",
    // "MY STRATEGY BLUEPRINT" (Gareth Packer/Financial Wisdom) — stop/MACD/NATR,
    // wspoldzielone przez strategy.js i signals.js (patrz komentarz w minicharts.js).
    BLUEPRINT_MAX_STOP_DISTANCE_PCT: "readonly",
    BLUEPRINT_NATR_MAX: "readonly",
    stopPriceFor: "readonly",
    strategyStopFor: "readonly",
    macdConfirmation: "readonly",
    currentNatr: "readonly",
