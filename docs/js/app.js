...
//    własnego indeksu i linia GLB (Green Line Breakout, Dr Eric Wish — running
//    maximum ceny: stoi płasko na starym szczycie, przeskakuje na nowy dopiero
//    gdy cena go przebije; punkt, w którym linia ceny DOTYKA linii GLB, to
//    właśnie moment przebicia), wszystko przeliczone na % zmiany względem
//    pierwszego wyświetlanego tygodnia OKNA MOMENTUM (patrz
    ...
    rsChartInstance = new Chart(canvas, {
        ...
        data: {
            ...
            datasets: [
                ...
                { label: "GLB (Green Line Breakout)", data: chartData.glb_pct, borderColor: "#39ff14", backgroundColor: "transparent", pointRadius: 0, borderWidth: 1.5, borderDash: [6, 3], stepped: true },
            ],
        },
        options: {
            responsive: true,
